import { ShieldCheck, UserRoundPlus, Workflow } from "lucide-react";
...
const highlights = [
  { icon: UserRoundPlus, title: "Entrada guiada", description: "Campos mais claros, força da senha visível e menos atrito no cadastro." },
  { icon: ShieldCheck, title: "Acesso controlado", description: "Novos acessos entram como atendente por padrão até ajuste administrativo." },
  { icon: Workflow, title: "Pronto para operar", description: "Depois do acesso, a equipe já entra em um painel mais moderno e organizado." },
];
        ...
        <div className="w-full max-w-md justify-self-center lg:max-w-lg lg:justify-self-end">
          <Card className="overflow-hidden rounded-[32px] animate-enter">
            <CardHeader className="p-5 pb-4 sm:p-8 sm:pb-6">
              ...
              <CardTitle className="text-[1.9rem] sm:text-[2rem]">Criar conta</CardTitle>
              <CardDescription>Novo acesso entra como atendente por padrão e pode ser promovido por um administrador depois.</CardDescription>
            </CardHeader>
